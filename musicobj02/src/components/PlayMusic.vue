<template>
    <div class="playMusic">
        ...
        <div v-else class="playContent" @click="isLyric=!isLyric" >
            ...
            <img class="needle" :class="{active: !pause}" src="@/assets/img/needle-ip6.png" alt="">
        ...
        <div class="playFooter">
            ...
            <svg class="icon" aria-hidden="true" >
                <use xlink:href="#icon-shangyishoushangyige" @click="tabMusic(-1)"></use>
            </svg>
            <svg class="icon" v-if="pause" aria-hidden="true" >
                <use xlink:href="#icon-bofang_huaban" @click="play"></use>
            </svg>
            <svg class="icon" v-else aria-hidden="true" >
                <use xlink:href="#icon-iconstop" @click="play"></use>
            </svg>
            <svg class="icon" aria-hidden="true" >
                <use xlink:href="#icon-xiayigexiayishou" @click="tabMusic(1)"></use>
            </svg>
            <svg class="icon" aria-hidden="true" >
...
export default{
    ...
    methods:{
        ...
        ...mapMutations(["setPlayIndex","setPlayLyric"])
    }
}
</script>
