<template>
    <div class="searchTop">
        <div class="searchTopNav">
            ...
            <div class="right">
                <input type="text" v-model="value" @change="search" >
            </div>
        </div>
            ...
            <div class="searchSongs-top">
                <div class="left">
                    ...
                    <div class="text">
                        ...
                        <div class="num" >(共{{musiclist.length}}首)</div>
                    </div>

                </div>
            </div>
            <div class="list">
                <div class="playItem" v-for="(item,index) in musiclist" :key="index" >
                    <div class="left">
    ...
    methods:{
        ...
        async search(){
            if(this.value==""){
                ...
                var res = await searchMusic(this.value);
                console.log(res)
        ...
        ...mapMutations(["pushPlayLyric","setPlayIndex"])
    }
}
</script>
